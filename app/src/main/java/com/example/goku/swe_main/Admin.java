                ...
                */
                ...
                mref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        String check_email = map.get("email");
                        String check_name = map.get("name");
                        String check_pass = map.get("password");

                        Log.v("E_Value", "Alert_message : " + email);
                        Log.v("E_Value", "info_msg : " + check_name);
                        Log.v("E_Value", "message : " + check_pass);
                        System.out.println("heloo ::" + check_pass + "  " + password);
                        // String value = (String) dataSnapshot.getValue();
                        //  System.out.println(value);
                        // Log.v("E_Value","message : "+value);
                        // alert_msg.setText(value);
                        if (check_pass.equals(password)) {
                            System.out.println(check_pass + "  " + password);
